...
## Il comando 'shellexec':
   ...
   **shellexec -c '\<comando shell\>' \[-f\]** <br/>
   ...
   - **shellexec -c 'start /B \[nome programma\] \<nome file\>' -f** <br/>
     fork di apertura di un file con un programma (se non viene specificato il programma, il file viene aperto con il suo programma di default
